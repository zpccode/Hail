...
class AppInfo(
    ...
    val state
        get() = when {
            ...
            AppManager.isAppFrozen(applicationInfo!!) -> State.FROZEN
            else -> State.UNFROZEN
        }

    override fun equals(other: Any?): Boolean = other is AppInfo && other.packageName == packageName && other.userId == userId
